...
class PostFollowingTabScreen extends StatefulWidget {
  final UserModel userModel;
  final User firebaseUser;

  const PostFollowingTabScreen({Key? key,required this.userModel, required this.firebaseUser}) : super(key: key);

  @override
  State<PostFollowingTabScreen> createState() => _PostFollowingTabScreenState();
}

class _PostFollowingTabScreenState extends State<PostFollowingTabScreen> {
  ...
  Future getuserid() async {
    ...
    print("post following vv $idtoken");
  }
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body:followersFollowingModel==null?
