...
class ProfileCommentClick extends StatefulWidget {
  const ProfileCommentClick({Key? key}) : super(key: key);

  @override
  State<ProfileCommentClick> createState() => _ProfileCommentClickState();
}

class _ProfileCommentClickState extends State<ProfileCommentClick> {
  @override
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                comments(name: 'Anyone', color: Theme.of(context).hoverColor, fsize: 16),
                SizedBox(
                ...
                comments(name: 'Friends', color: Theme.of(context).hoverColor, fsize: 16),
  ...
  Widget comments({required String name,required Color color,required double fsize}){
    return Padding(
